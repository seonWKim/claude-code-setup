...
import { askQuestionsWithGoBack } from '../utils/wizard.js';
...
export async function askProjectQuestions(isFirstSection: boolean = true): Promise<ProjectAnswers> {
  return askQuestionsWithGoBack<ProjectAnswers>(projectQuestions, isFirstSection);
}
